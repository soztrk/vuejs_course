<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid:nameInputValidity==='invalid'}">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="name" @blur="validateInput"/>
      <p v-if="nameInputValidity === 'invalid'">Please enter something</p>
    </div>
    ...
    <div class="form-control">
      <RatingControl title="Rating" v-model="rating" />
    </div>
    <div class="form-control">
        <input id="interest-news" name="interest" type="checkbox" value="news" v-model="terms" />
        <label for="interest-news">Agree to terms of use?</label>
    </div>
    <div>
...
export default{
  ...
  methods:{
    submitForm(){
      ...
      console.log("age=",this.age,this.$refs.ageInput.value)
      ...
      // reset form
      this.name = ""
      this.age = this.how = this.rating = null
      this.referrer= "wom"
      this.interest= []
      this.terms = false
    },
    validateInput(){
      if(this.name === "") this.nameInputValidity = "invalid"
      else this.nameInputValidity = "valid"
    }
  },
  components:{
    RatingControl
